...
from ode_models import il2_model, timer_model, null_model, C_model, timer_il2_model, core_model_gamma, core_model_timer_il2
import pandas as pd
...
for readout_fun, norm in zip(readout_fun_list, norm_list):
    ...
    heatmap_arr = get_heatmap(arr_myc, arr_il2, name1, name2, time, d, model, 
                              readout_fun, norm = norm, core_model = core_model_gamma)
