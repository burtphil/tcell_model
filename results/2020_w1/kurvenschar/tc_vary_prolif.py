# -*- coding: utf-8 -*-
"""
vary beta p and plot time course
"""
...
# plot a colored norm line for specific beta_p?
...
cbar = g.fig.colorbar(sm, ax = g.axes, ticks = [arr[0], arr[int(len(arr)/2)], arr[-1]])
cbar.set_label(r"$\beta_p$")
g.savefig("../figures/prolif_tc.pdf")
#g.savefig("../figures/proliferation_timecourse.svg")
